...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("new", "analyzing", "analyzed", "scored", "personalized", "contacted", "converted", "rejected", name="leadstatus"), nullable=False, server_default="new"),
        sa.Column("ai_score", sa.Integer(), nullable=True),
        sa.Column("score_breakdown", sa.Text(), nullable=True),
        sa.Column("website_quality", sa.Enum("none", "poor", "average", "good", "excellent", name="websitequality"), nullable=True),
